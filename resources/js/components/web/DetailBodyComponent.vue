        ...
        <div class="modal-content rounded-0 border-0">
          ...
          <div class="modal-body text-center p-4 p-md-5 pt-2">
            ...
            <p class="text-muted mb-4 small">
              Descripción de cada producto y precios con opción de compra bajo pedido para tallas sin stock
            </p>
        ...
        <div class="modal-content rounded-0 border-0 shadow">
          ...
          <div class="modal-body p-4 p-md-5 text-center">
            ...
            <div v-else>
              ...
              <textarea v-model="reviewComment" class="form-control rounded-0 mb-4" rows="4" placeholder="Tu experiencia..."></textarea>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 p-4 p-md-5 text-center border-0 shadow">
          ...
          <div class="d-flex flex-column gap-2">
            <a href="/user" class="btn btn-dark rounded-0 py-2">Login</a>
            <a href="/register" class="btn btn-outline-dark rounded-0 py-2">Registro</a>
          </div>
        </div>
      </div>
    </div>
...
.product-image-section {
  margin-top: -20px; /* Bajada ligeramente de -40px */
}
...
.btn-whatsapp i {
  font-size: 3rem; /* Agranda el icono */
}
...
.custom-progress { height: 12px; background-color: #f0f0f0; border-radius: 10px; box-shadow: none; }
.custom-progress-bar { background-color: #7a7a7a !important; border-radius: 10px; }
.star-label { width: 40px; font-weight: 600; font-size: 0.9rem; color: #7a7a7a; }
.count-label { width: 30px; text-align: right; }

.stars .filled { color: #7a7a7a; font-size: 1.2rem; }
.stars .empty { color: #ccc; font-size: 1.2rem; }
.stars-small .filled-small { color: #7a7a7a; font-size: 0.8rem; }
.stars-small .empty-small { color: #e0e0e0; font-size: 0.8rem; }

.size-guide-table th { background: #000; color: #fff; font-weight: 700; padding: 10px; border: none; border-right: 5px solid #fff; text-transform: uppercase;}
