...
.product-img-full { width: 100%; height: 100%; object-fit: cover; transition: transform 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94); }
...
.btn-buy:hover { background: #5498cf; border-color: #5498cf; color: #ffffff; }
...
.btn-view { background: transparent; border: none; color: #ccc; padding: 0; transition: color 0.2s; }
