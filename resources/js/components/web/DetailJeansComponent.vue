      ...
      <div class="row g-0">
        ...
        <div class="col-lg-6 col-md-6">
          <div class="product-details">
            ...
            <div class="rating-section d-flex mb-3">
              <div class="stars">
                <i v-for="star in 5" :key="star"
                  :class="star <= Math.round(averageRating) ? 'fas fa-star filled' : 'far fa-star empty'"></i>
              </div>
              <span class="rating-text ms-3">{{ reviewCount }} calificaciones</span>
            </div>
          ...
          <div class="row">
            <div class="col-md-4 text-center border-end-md">
              ...
              <div class="review-meta text-muted small">
                ...
                <a href="#" @click.prevent="showQualifyModal" class="text-decoration-underline text-dark text-rating">Calificar</a>
              </div>
...
.color-option.active {
  transform: scale(1.1);
  box-shadow: 0 0 0 2px #fff, 0 0 0 3px #6da5da; 
...
.stars .filled { color: #6da5da; font-size: 1.2rem; } /* Estrellas negras/gris oscuro */
...
.progress-bar {
  background-color: #6da5da !important; /* Color Taupe/Gris de la imagen */
  border-radius: 10px;
}
.count-label {
  width: 30px;
...
.stars-small .filled-small { color: #6da5da; font-size: 0.8rem; } /* Estrellas pequeñas grises */
