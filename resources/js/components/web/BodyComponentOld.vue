<template>
  ...
  <div class="favorites-sidebar" :class="{ 'active': showCartSidebar }">
    ...
    <div class="sidebar-content">
      ...
      <div v-else class="favorites-list">
        <div v-for="product in products_carrito" :key="product.ProductID" class="favorite-item">
          <div class="favorite-image">
            <img :src="product.images[0]?.ImagePath" :alt="product.Name" class="img-fluid">
          </div>
          <div class="favorite-info">
            <h6 class="product-name">{{ product.Name }}</h6>
            <p class="product-price">S/{{ product.Price }}</p>
            <div v-if="product.selectedSize" class="product-size">
              <small>Talla: {{ getSizeName(product.selectedSize, product.sizes) }}</small>
            </div>
          </div>
          <div class="favorite-actions">
            <button class="btn-remove-favorite" @click="removeFromCart(product)" title="Quitar del carrito">
    ...
    <div class="fourth-section">
      <div class="fourth-section-filters d-flex flex-wrap">
        <div class="col-lg-3 col-12 content-filter d-flex flex-column">
          <div class="form-group filter-group1">
            <div class="d-flex justify-content-between align-items-center">
              <label class="title-filter" for="">ORDENAR</label>
            </div>

            <div class="mb-3 position-relative" style="border: 1px solid #000;">
          ...
          <div class="form-group filter-group2">
            <div class="d-flex justify-content-between align-items-center cursor-pointer"
              ...
              <label class="title-filter" for="">TALLAS</label>
          ...
          <div class="d-flex flex-wrap justify-content-around">
            <div class="row content-card-images">
              <div class="col-12 col-lg-3 col-md-4 card-images"
                v-for="(item, index) in filteredProducts.filter(item=>item.Tipo == 'Bodys')" :key="index">
    ...
    <div class="row footer-section-contact">
      ...
      <div class="col-md-4 section-middle">
        ...
        <small>
          ...
          de Skinly. Consulta nuestros <a href="#">Términos y Condiciones</a> | <a href="#">Política de Privacidad</a>.
        </small>
      </div>
